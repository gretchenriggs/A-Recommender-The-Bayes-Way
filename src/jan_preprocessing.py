...
def make_train_set(entry, avg, one_point = False):
...
# --------- updating the columns by category
    ...
    nlp = spacy.load('en')
    for col in nlp_cols:
        vec = scott_nlp.compute_nlp_vectors_from_df(nlp, df, col)
...
if __name__ == '__main__':
    ...
    df = make_train_set(df, avg = average)
